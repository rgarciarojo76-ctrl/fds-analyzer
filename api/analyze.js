...
- SECCIÓN 1 (Identificación) [ESTRICTO PRL]: EXTRACCIÓN LITERAL MÍNIMA.
  SOLO extraer información crítica PRL. OMITIR datos administrativos (Direcciones, Emails, Webs, REACH, CLP, Artículos).
  Campos a incluir (Orden estricto):
  1. Identificador de producto.
  2. Número CAS.
  3. Usos pertinentes identificados.
  4. Usos desaconsejados.
  5. Nombre del Proveedor (SOLO el nombre, OMITIR dirección/contacto administrativo).
  6. Teléfono de emergencia.
  FORMATO: "Campo: Valor literal (Ref. Pág. X)".
